...
2. Enter your Splunk URL, which is the pointer to your Splunk instance. Ensure that you have a port at the end of the URL. The default port is `8088`, so your URL would be `https://prd-p-2k3mp2xhznbs.cloud.splunk.come:8088`. 
